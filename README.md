...
packages own one slice of this work, depictr aims to cover it end to end with
...
depictr deliberately spans the workflow rather than competing feature-for-feature
...
(Bayesian). depictr gives you a consistent, good-looking default across all of
