...
`model_report()` composes several of these views (the coefficients, the effect
of a focal predictor, the residuals against fitted values and a Q-Q plot, with a
fit-statistics subtitle) into a single figure for a rapid review or a report
appendix.
