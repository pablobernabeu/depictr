...
#' correlation_matrix_plot(crop_yield, method = "spearman", show_values = FALSE)
correlation_matrix_plot <- function(data, cols = NULL, method = "pearson",
