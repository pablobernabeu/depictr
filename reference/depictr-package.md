...
depictr provides a consistent, publication-ready set of plots that span
the whole analysis workflow – from a first look at the data, through
model estimates and predictions, to diagnostics, uncertainty and
reporting. Every plotting function returns a
